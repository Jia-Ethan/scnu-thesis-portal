    ...
    <main className="public-page">
      ...
      >
        ...
        <div className="public-hero-copy">
          ...
          <h1 id="sc-th-title" className="minimal-logo">
            华师本科论文格式合规与 AI 协作工作台
          </h1>
          <p className="public-subtitle">
            把论文材料、格式检查、老师批注、建议队列、版本和导出放进同一个可追溯项目空间。公开站默认只做本地快速导出，不启用远程 AI。
          </p>
        ...
        <section id="quick-export" className="public-export-panel" aria-label="在线快速导出">
          <div className="public-export-copy">
            ...
            <h2>上传 .docx 或粘贴正文，先做结构预检，再导出规范化 Word。</h2>
          </div>
          <HomeComposer
      ...
      <section className="public-section public-boundary" aria-labelledby="privacy-title">
        <div>
          ...
          <h2 id="privacy-title">公开站不发送真实论文到远程模型。</h2>
        </div>
      ...
      <section id="self-host" className="public-section public-self-host" aria-labelledby="self-host-title">
        <div className="public-section-head">
          ...
          <p>公开 Vercel 站点用于产品体验与快速导出；完整 Workbench、访问码保护、Provider key 服务端封存和 Ollama 本地模型更适合私有环境。</p>
        </div>
...
const demoFlow = [
  { index: "01", title: "上传材料", description: "上传 .docx 或粘贴正文，快速进入结构识别。" },
...
const privacyRules = [
  ...
  { title: "远程 AI 默认关闭", description: "公开站不开放匿名远程 Provider；敏感论文建议私有部署。" },
];

const roadmapItems = [
  "Phase 0: Public Site / README / Privacy",
  "Phase 1: Workbench demo project / empty states / export history",
  "Phase 2: thesis_jobs / typed streaming / cancel retry",
  "Phase 3: Director + Agent registry + Provider runtime",
  "Phase 4: Comment Resolver / Project Package / OCR",
];
